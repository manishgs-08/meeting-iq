  ...
  return (
    <div className="w-full max-w-xl mx-auto">
        ...
        {!selectedFile ? (
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="flex-shrink-0 rounded-lg p-2 text-slate-400 hover:text-red-400 hover:bg-red-400/10 transition-colors duration-200"
      ...
      <p className="mt-2 text-center text-xs text-slate-500">
        Backend integration will be implemented in Phase 5.2.
      </p>
    </div>
  );
}
